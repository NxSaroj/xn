...
export async function run ({ interaction }: SlashCommandProps) {
  ...
  const button3Row = new ActionRowBuilder<ButtonBuilder>().addComponents(saveButton);
  ...
  try {
    ...
    confirmation.on("collect", async (i) => {
      ...
      if (i.customId === "disc") {
        ...
        const secondMessageFilter = (m:import('discord.js').Message) => m.author.id == interaction.user.id;
      ...
      if (i.customId === "img") {
        ...
        const thirdMessageFilter = (m:import('discord.js').Message) => m.author.id == interaction.user.id;
      ...
      if (i.customId === "thumb") {
        ...
        const fourthMessageFilter = (m:import('discord.js').Message) => m.author.id == interaction.user.id;
      ...
      if (i.customId === "color") {
        ...
        const fifthMessageFilter = (m:import('discord.js').Message) => m.author.id == interaction.user.id;
      ...
      if (i.customId == "json") {
        ...
        const sixthMessageFilter = (m:import('discord.js').Message) => m.author.id == interaction.user.id;
