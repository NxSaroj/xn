          ...
          if (isMLogEnabled.messageLog == true) {
            logsConfig
              ...
              .then(() => {
                ...
                embed.fields[0].value = emojis.wrong;
            ...
            embed.fields[0].value = emojis.xn_tick;
          ...
          if (isCLogEnabled.channelLog == true) {
            logsConfig
              ...
              .then(() => {
                ...
                embed.fields[1].value = emojis.xn_wrong;
                response.edit({ embeds: [embed] });
              })
              .catch((err) => {
                console.error(err);
            ...
            embed.fields[1].value = emojis.xn_tick;
            response.edit({ embeds: [embed] }).catch((err: any) => {
              console.error(err);
              i.editReply({ content: "DB Error, Try again later" });
              return;
            });
          ...
          if (isWLogEnabled.messageLog == true) {
            logsConfig
              ...
              .then(() => {
                ...
                embed.fields[2].value = emojis.xn_wrong;
                response.edit({ embeds: [embed] });
              })
              .catch((err: any) => {
                console.error(err);
            ...
            logsConfig
              ...
              .then(() => {
                ...
                embed.fields[2].value = emojis.xn_tick;
                response.edit({ embeds: [embed] });
              })
              .catch((err: any) => {
                console.error(err);
