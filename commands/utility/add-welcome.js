...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription("Templates - {target(user.mention)}, {target(user.username)}, {guild.name}")
